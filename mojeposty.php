                        ...
                        <tr>
                            ...
                            <td>
                                <form action="./mojeposty.php" method="POST">
                                    <button class="btn btn-secondary" type="submit" name="editview_post" value="<?= $post['threads_id']; ?>">Edytuj
                                    </button>
                                    <button class="btn btn-danger" type="submit" name="delete_post" value="<?= $post['threads_id']; ?>">Usuń
                                    </button>
                                </form>
                            </td>
                        </tr>
