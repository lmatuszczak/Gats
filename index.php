...
<body>
    <!-- W zależności kto jest zalogowany generuj odpowiedni navbar -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            // Wyświetlanie ewentualnego komuniktu o błędzie
            if (isset($_SESSION['e'])) {
                echo $_SESSION['e'];
                unset($_SESSION['e']);
            }
            ...
            try {
                ...
                // $_SESSION['e'] = $e->getMessage(); //Informacja szczegółowa o błędzie
            }
            ?>
        </div>
        <!-- Paginacja na stronie -->
        <?php
